...
document.addEventListener("DOMContentLoaded", function(){
	...
	if ((searchQuery != "") && (searchQuery != null)){
		...
		if (searchQuery != ""){
			var requestURL = 'html_entries/bor_'+searchQuery+'.html'; // "_" to avoid "con.html" windows problem
			...
			if ((htmlDef != null)&&(htmlDef.getElementById("definition")!=null)){
				...
				for (let i = 0; i < elements.length; i++) elements[i].href="https://www.sanskrit-lexicon.uni-koeln.de/scans/csl-apidev/servepdf.php?dict=BOR&page="+elements[i].getAttribute("href").slice(21);
